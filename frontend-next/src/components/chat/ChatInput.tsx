...
export default function ChatInput({ disabled, onSend }: Props) {
  ...
  return (
    <div className="flex shrink-0 justify-center border-t border-border/70 bg-background/80 px-3 py-3 backdrop-blur-md">
      <div className="flex w-full max-w-[720px] items-end gap-2">
      <Button
        variant="secondary"
        size="icon"
      ...
      <textarea
        ref={textareaRef}
        className="max-h-[140px] min-h-9 flex-1 resize-none rounded-sm border border-input bg-card/80 px-3 py-2 text-[15px] leading-relaxed outline-none transition-colors placeholder:text-muted-foreground/60 focus:border-primary"
