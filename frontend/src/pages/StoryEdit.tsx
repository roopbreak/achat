    ...
    <>
      <div style={{ maxWidth: 960, margin: '0 auto', padding: '0 16px', display: 'flex', flexDirection: 'column', height: 'calc(100dvh - 56px)' }}>
        ...
        <div style={{ flex: 1, minHeight: 0 }}>
          ...
          {mainTab === 'response' && <ResponseTab {...form.responseComposition} />}
        </div>
