...
export const OUTPUT_TARGETS = {
  ...
  4096:  '감각 묘사와 대사를 풍부하게, 심리 묘사도 포함. 장면을 서두르지 말고 천천히 전개. 1800~2400자 권장 — 본체가 1600자 미만이 되지 않도록. 본문이 1600자에 못 미치면 상태창·선택지로 넘어가지 말고 현재 장면을 계속 전개할 것.',
  8192:  '장면을 매우 상세하게 묘사. 감각·대사·심리·내적 모순을 빠짐없이 포함. 한 장면을 끝까지 풀어서 서술. 2400~3600자 권장 — 본체가 2200자 미만이 되지 않도록. 본문이 2200자에 못 미치면 상태창·선택지로 넘어가지 말고 현재 장면을 계속 전개할 것.',
};
