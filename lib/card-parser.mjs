...
export function parseAndImportCard(storyName, jsonData) {
  ...
  upsertStory({ name: storyName, char_name: charName, description, personality, scenario, first_mes: firstMes, post_history_instructions: postHistoryInstructions, narration_style: narrationStyle, narration_style_source: narrationStyleSource });
