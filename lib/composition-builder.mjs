...
const SCENE_TEMPLATES = {
  ...
  adult: [
    { id: 'adult-missionary-01', name: '정상위', outfit: '((completely nude)), ((naked)), bare skin, no clothes,', pose: '((1boy)), ((hetero)), ((faceless male)), ((male face out of frame)), missionary, lying on back, legs spread,', custom_negative: '+visible male face, ((rolling eyes)), ((white eyes)), ((empty eyes)), ((no pupils)), uncensored genitals' },
    { id: 'adult-doggy-01', name: '후배위', outfit: '((completely nude)), ((naked)), bare skin, no clothes,', pose: '((1boy)), ((hetero)), ((faceless male)), ((male face out of frame)), doggystyle, all fours, from behind,', custom_negative: '+visible male face, ((rolling eyes)), ((white eyes)), ((empty eyes)), ((no pupils)), uncensored genitals' },
    { id: 'adult-cowgirl-01', name: '기승위', outfit: '((completely nude)), ((naked)), bare skin, no clothes,', pose: '((1boy)), ((hetero)), ((faceless male)), ((male face out of frame)), cowgirl position, straddling, sitting on lap,', custom_negative: '+visible male face, ((rolling eyes)), ((white eyes)), ((empty eyes)), ((no pupils)), uncensored genitals' },
    { id: 'adult-side-01', name: '측위', outfit: '((completely nude)), ((naked)), bare skin, no clothes,', pose: '((1boy)), ((hetero)), ((faceless male)), ((male face out of frame)), spooning, lying on side,', custom_negative: '+visible male face, ((rolling eyes)), ((white eyes)), ((empty eyes)), ((no pupils)), uncensored genitals' },
    { id: 'adult-standing-01', name: '입위', outfit: '((completely nude)), ((naked)), bare skin, no clothes,', pose: '((1boy)), ((hetero)), ((faceless male)), ((male face out of frame)), standing sex, against wall, leg lift,', custom_negative: '+visible male face, ((rolling eyes)), ((white eyes)), ((empty eyes)), ((no pupils)), uncensored genitals' },
    { id: 'adult-kiss-01', name: '키스', outfit: '((completely nude)), ((naked)), bare skin, no clothes,', pose: '((1boy)), ((hetero)), ((faceless male)), ((male face out of frame)), kissing, french kiss, tongue,', custom_negative: '+visible male face, ((rolling eyes)), ((white eyes)), ((empty eyes)), ((no pupils)), uncensored genitals' },
    { id: 'adult-oral-01', name: '오럴', outfit: '((completely nude)), ((naked)), bare skin, no clothes,', pose: '((1boy)), ((hetero)), ((faceless male)), ((male face out of frame)), fellatio, on knees, looking up,', custom_negative: '+visible male face, ((rolling eyes)), ((white eyes)), ((empty eyes)), ((no pupils)), uncensored genitals' },
    { id: 'adult-paizuri-01', name: '파이즈리', outfit: '((completely nude)), ((naked)), bare skin, no clothes,', pose: '((1boy)), ((hetero)), ((faceless male)), ((male face out of frame)), paizuri, breast squeeze,', custom_negative: '+visible male face, ((rolling eyes)), ((white eyes)), ((empty eyes)), ((no pupils)), uncensored genitals' },
    { id: 'adult-afterglow-01', name: '사후', outfit: '((completely nude)), ((naked)), bare skin, no clothes,', pose: 'lying down, afterglow, sweaty, satisfied, on bed,', expression: 'exhausted, blush, happy, closed eyes,' },
    { id: 'adult-bath-01', name: '목욕', outfit: '((completely nude)), ((naked)), bare skin, no clothes,', pose: 'bathing, in bathtub, steam, wet hair, wet skin,' },
    { id: 'adult-prone-01', name: '엎드려', outfit: '((completely nude)), ((naked)), bare skin, no clothes,', pose: '((1boy)), ((hetero)), ((faceless male)), ((male face out of frame)), prone bone, face down, from behind,', custom_negative: '+visible male face, ((rolling eyes)), ((white eyes)), ((empty eyes)), ((no pupils)), uncensored genitals' },
    { id: 'adult-reverse-cowgirl-01', name: '역기승위', outfit: '((completely nude)), ((naked)), bare skin, no clothes,', pose: '((1boy)), ((hetero)), ((faceless male)), ((male face out of frame)), reverse cowgirl, facing away,', custom_negative: '+visible male face, ((rolling eyes)), ((white eyes)), ((empty eyes)), ((no pupils)), uncensored genitals' },
    { id: 'adult-against-wall-01', name: '벽치기', outfit: '((completely nude)), ((naked)), bare skin, no clothes,', pose: '((1boy)), ((hetero)), ((faceless male)), ((male face out of frame)), against wall, pressed against wall, from behind,', custom_negative: '+visible male face, ((rolling eyes)), ((white eyes)), ((empty eyes)), ((no pupils)), uncensored genitals' },
    { id: 'adult-shower-01', name: '샤워', outfit: '((completely nude)), ((naked)), bare skin, no clothes,', pose: 'shower, wet hair, water droplets, standing, steam,' },
    { id: 'adult-spread-01', name: '벌리기', outfit: '((completely nude)), ((naked)), bare skin, no clothes,', pose: 'legs spread, lying on back, inviting, on bed,', expression: 'blush, embarrassed, looking away,' },
    { id: 'adult-ride-01', name: '올라타기', outfit: '((completely nude)), ((naked)), bare skin, no clothes,', pose: '((1boy)), ((hetero)), ((faceless male)), ((male face out of frame)), girl on top, riding, bouncing,', custom_negative: '+visible male face, ((rolling eyes)), ((white eyes)), ((empty eyes)), ((no pupils)), uncensored genitals' },
    { id: 'adult-masturbation-01', name: '자위', outfit: '((completely nude)), ((naked)), bare skin, no clothes,', pose: 'masturbation, hand between legs, lying on bed,', expression: 'blush, moaning, pleasure,' },
    { id: 'adult-undressing-01', name: '탈의', outfit: 'undressing, pulling off shirt, partially clothed,', pose: 'standing, looking at viewer,', expression: 'blush, shy, seductive,' },
    { id: 'adult-morning-after-01', name: '다음날 아침', outfit: 'oversized shirt, no pants, bare legs,', pose: 'sitting on bed edge, morning light, stretching,', expression: 'sleepy, satisfied, gentle smile,' },
    { id: 'adult-tied-01', name: '구속', outfit: '((completely nude)), ((naked)), bare skin, no clothes,', pose: 'arms tied, ribbon bondage, on bed,', expression: 'blush, embarrassed, teary eyes,', custom_negative: '+visible male face, ((rolling eyes)), ((white eyes)), ((empty eyes)), ((no pupils)), uncensored genitals' },
  ],
};
...
export function buildComposition(storyName, { basePrompt = '', baseNegative = '' } = {}) {
  ...
  console.log(`[Composition] ${storyName}: 템플릿 생성 완료 (${images.length}장)`);
  return composition;
}
