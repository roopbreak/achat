...
const SCENE_TEMPLATES = {
  ...
  adult: [
    ...
    { id: 'adult-spread-01', name: '벌리기', outfit: '((completely nude)), ((naked)), bare skin, no clothes, nipples, areolae, navel, pussy,', pose: 'legs spread, lying on back, inviting, on bed,', framing: 'full body,', expression: 'blush, embarrassed, looking away,' },
